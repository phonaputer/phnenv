...
var test_parse_TagOpts_PositiveCases = []struct {
	...
	{"ignore irrelevant tags - float", &struct {
		F float64 `phnenv:"TESTENV,rune,base:2"`
	}{}, "123", &struct {
		F float64 `phnenv:"TESTENV,rune,base:2"`
	}{F: 123}},
	{"ignore irrelevant tags - string", &struct {
...
var test_parse_TagOpts_NegativeCases = []struct {
	...
	{"empty tag", &struct {
		F int `phnenv:""`
	}{}, "10", "must contain at minimum an environment variable"},
	{"tag missing conf key", &struct {
		F int `phnenv:",base:2"`
	}{}, "10", "must contain at minimum an environment variable"},
	{"unknown option", &struct {
		F int `phnenv:"E,what"`
	}{}, "10", "unsupported struct tag option"},
	{"duplicate rune", &struct {
		F int `phnenv:"E,rune,rune"`
	}{}, "10", "rune option must only be provided once"},
	{"duplicate base", &struct {
		F int `phnenv:"E,base:1,base:1"`
	}{}, "10", "base option must only be provided once"},
	{"duplicate bitsize", &struct {
		F int `phnenv:"E,bitsize:8,bitsize:8"`
	}{}, "10", "bitsize option must only be provided once"},
	{"empty bitsize", &struct {
		F int `phnenv:"E,bitsize:"`
	}{}, "10", ""},
	{"empty base", &struct {
		F int `phnenv:"E,base:"`
	}{}, "10", ""},
	{"invalid bitsize", &struct {
...
var test_parse_NoEnvVarFound_ShouldKeepOriginalValue = []struct {
	...
	{"pointer", &struct {
		F *string `phnenv:"wrong"`
	}{&helloStr}, "asdg", &struct {
		F *string `phnenv:"wrong"`
	}{F: &helloStr}},
	{"slice", &struct {
		F []string `phnenv:"wrong"`
	}{[]string{"hello", "goodbye"}}, "nope,2", &struct {
		F []string `phnenv:"wrong"`
...
var test_parse_EnvVarExistsButIsInvalid_ShouldReturnError = []struct {
	...
	{"uint64 overflow", &struct {
		F uint64 `phnenv:"TESTENV"`
	}{}, "99999999999999999999999"},
	{"float32", &struct {
		F float32 `phnenv:"TESTENV"`
	}{}, "abc"},
	{"float32 overflow", &struct {
		F float32 `phnenv:"TESTENV"`
	}{}, "3.40282346638528859811704183484516925440e+39"},
	{"float64", &struct {
		F float64 `phnenv:"TESTENV"`
	}{}, "abc"},
	{"float64 overflow", &struct {
		F float64 `phnenv:"TESTENV"`
	}{}, "1.797693134862315708145274237317043567981e+309"},
	{"complex64", &struct {
		F complex64 `phnenv:"TESTENV"`
	}{}, "abc"},
	{"complex64 overflow", &struct {
		F complex64 `phnenv:"TESTENV"`
	}{}, "3.40282346638528859811704183484516925440e+39"},
	{"complex128", &struct {
		F complex128 `phnenv:"TESTENV"`
	}{}, "abc"},
	{"complex128 overflow", &struct {
		F complex128 `phnenv:"TESTENV"`
	}{}, "1.797693134862315708145274237317043567981e+309"},
	{"pointer", &struct {
		F *int `phnenv:"TESTENV"`
